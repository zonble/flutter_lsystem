    ...
    var commands = [
      SetMacro('a', [
        IfElse((_) => _['l'] < 10.0, [
          ...
          Left((_) => 20.0 + (controller.value * 5) / max(1, _value / 100.0)),
          RunMacro('a', (_) => {'l': (_['l'] / 5.0 * 4.0)}),
          Right((_) => 40.0 - (controller.value * 5 / max(1, _value / 100.0))),
      ...
      SetMacro('b', [
        IfElse((_) => _['l'] < 10.0, [
          ...
          Forward((_) => 4.0),
          Forward((_) => min(_['l'], 60.0)),
          Right((_) => 20.0 + (controller.value * 10) / max(1, _value / 100.0)),
          RunMacro('a', (_) => {'l': (_['l'] / 5.0 * 4.0)}),
        ]),
      ]),
      Back((_) => 200),
